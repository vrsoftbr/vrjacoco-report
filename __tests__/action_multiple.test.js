  ...
  describe("Pull Request event", function () {
    ...
    it("publish proper comment", async () => {
      ...
      expect(comment.mock.calls[0][0].body)
        .toEqual(`|Arquivo|Cobertura [65.91%]|:white_check_mark:|
|:-|:-:|:-:|
|[Math.kt](https://github.com/thsaravana/jacoco-android-playground/src/main/java/com/madrapps/math/Math.kt)|70.37%|:white_check_mark:|
...
|Cobertura Total do Projeto|25.32%|:white_check_mark:|
|:-|:-:|:-:|`);
    });
